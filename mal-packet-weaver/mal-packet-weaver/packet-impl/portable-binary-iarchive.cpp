...
namespace boost
{
    namespace archive
    {
        namespace detail
        {
            template class archive_serializer_map<mal_packet_weaver::portable_binary_iarchive>;
        }

        template class basic_binary_iprimitive<mal_packet_weaver::portable_binary_iarchive, std::istream::char_type,
