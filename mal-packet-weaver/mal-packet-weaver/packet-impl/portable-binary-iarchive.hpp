...
namespace mal_packet_weaver
{
    ...
    public:
        portable_binary_iarchive(std::istream &is, unsigned flags = 0)
            : primitive_base_t(*is.rdbuf(), 0 != (flags & ::boost::archive::no_codecvt)),
...
BOOST_SERIALIZATION_REGISTER_ARCHIVE(mal_packet_weaver::portable_binary_iarchive)
#endif

// required by export in boost <= 1.34
#define BOOST_ARCHIVE_CUSTOM_IARCHIVE_TYPES mal_packet_weaver::portable_binary_iarchive
