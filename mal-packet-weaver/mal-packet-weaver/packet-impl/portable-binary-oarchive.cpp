...
namespace boost
{
    namespace archive
    {
        ...
        namespace detail
        {
            template class archive_serializer_map<mal_packet_weaver::portable_binary_oarchive>;
        }

        template class basic_binary_oprimitive<mal_packet_weaver::portable_binary_oarchive, std::ostream::char_type,
