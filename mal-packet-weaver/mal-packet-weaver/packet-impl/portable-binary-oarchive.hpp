...
#include "portable-binary-archive.hpp"
// clang-format: on
...
namespace mal_packet_weaver
{
    ...
    public:
        ...
        portable_binary_oarchive_exception([[maybe_unused]] exception_code c = invalid_flags) {}
...
// required by export in boost version > 1.34
    ...
    BOOST_SERIALIZATION_REGISTER_ARCHIVE(mal_packet_weaver::portable_binary_oarchive)
#endif

// required by export in boost <= 1.34
#define BOOST_ARCHIVE_CUSTOM_OARCHIVE_TYPES mal_packet_weaver::portable_binary_oarchive
